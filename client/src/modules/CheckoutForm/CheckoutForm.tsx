...
const CheckoutForm = ({ amount, onSuccess, orderData }: CheckoutPageProps) => {
  ...
  return (
    <CheckoutContent onSubmit={handleSubmit}>
      ...
      <Button variant="contained" disabled={loading || !stripe} sx={{ width: '100%', marginTop: theme.spacing(2) }} type="submit">
